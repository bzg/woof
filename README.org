...
⚠️ Woof is not maintained, its successor is [[https://codeberg.org/bzg/bark][Bark]].

⚠️ The project is active on [[https://codeberg.org/bzg/woof][Codeberg]] (for issues and patches) and
mirrored on [[https://github.com/bzg/woof/][GitHub]].
...
See [[https://tracker.orgmode.org][tracker.orgmode.org]] for an example instance tracking [[https://list.orgmode.org/][the Org Mode
mailing list]].
